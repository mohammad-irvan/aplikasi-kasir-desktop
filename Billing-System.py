...
class Bill_App:
    def __init__(self,root):
        ...
        self.root.title("Kasir")
        title=Label(self.root,text="Kasir",bd=12,relief=RIDGE,font=("Arial Black",20),bg="#A569BD",fg="white").pack(fill=X)
        #===================================variables=======================================================================================
        self.nutella=IntVar()
        self.noodles=IntVar()
        self.lays=IntVar()
        ...
        cust_name=Label(details,text="Nama Pelanggan",font=("Arial Black",14),bg="#A569BD",fg="white").grid(row=0,column=0,padx=15)
        
        cust_entry=Entry(details,borderwidth=4,width=30,textvariable=self.c_name).grid(row=0,column=1,padx=8)
        
        contact_name=Label(details,text="Kontak",font=("Arial Black",14),bg="#A569BD",fg="white").grid(row=0,column=2,padx=10)
        ...
        item4=Label(snacks,text="Oreo(20kg)",font=("Arial Black",11),bg="#E5B4F3",fg="#6C3483").grid(row=3,column=0,pady=11)
        ...
        item6=Label(snacks,text="Dairy Milk Silk(60kg)",font=("Arial Black",11),bg="#E5B4F3",fg="#6C3483").grid(row=5,column=0,pady=11)
        item6_entry=Entry(snacks,borderwidth=2,width=15,textvariable=self.silk).grid(row=5,column=1,padx=10)

        item7=Label(snacks,text="Namkeen(15kg)",font=("Arial Black",11),bg="#E5B4F3",fg="#6C3483").grid(row=6,column=0,pady=11)
        ...
        bill_title=Label(billarea,text="Pembayaran",font=("Arial Black",17),bd=7,relief=GROOVE,bg="#E5B4F3",fg="#6C3483").pack(fill=X)
...
def total(self):
    if (self.c_name.get=="" or self.phone.get()==""):
        messagebox.showerror("Error", "Isi Detail Pelanggan secara lengkap!!")
    ...
    total_snacks_price=(
                ...
                self.si+
                self.na)          
    self.total_sna.set(str(total_snacks_price)+" Rp")
    self.a.set(str(round(total_snacks_price*0.05,3))+" Rp")
    ...
    self.total_gro.set(str(total_grocery_price)+" Rp")
    self.b.set(str(round(total_grocery_price*0.01,3))+" Rp")
    ...
    self.total_hyg.set(str(total_hygine_price)+" Rp")
    self.c.set(str(round(total_hygine_price*0.10,3))+" Rp")
    ...
    self.total_all_bil=str(self.total_all_bill)+" Rp"
    billarea(self)
def intro(self):
    self.txtarea.delete(1.0,END)
    self.txtarea.insert(END,"\tWELCOME TO AMIK MARKET\n\tPhone-No.739275410")
